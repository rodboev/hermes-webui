...
import re
from tests.i18n_locale_loader import locale_block
...
def test_japanese_locale_covers_english_keys():
    ...
    via the split locale bundles fallback path. The profile-concept help copy intentionally
